...
var routes = [
    ...
    },
    {
        path: "login",
        loadChildren: function () {
            return Promise.all(/*! import() | pages-login-login-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-login-login-module")]).then(__webpack_require__.bind(null, /*! ./pages/login/login.module */ "./src/app/pages/login/login.module.ts")).then(function (m) { return m.LoginModule; });
        }
    },
    {
        path: "signup",
        loadChildren: function () {
            return Promise.all(/*! import() | pages-signup-signup-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-signup-signup-module")]).then(__webpack_require__.bind(null, /*! ./pages/signup/signup.module */ "./src/app/pages/signup/signup.module.ts")).then(function (m) { return m.SignUpModule; });
        }
    },
    {
        path: "app",
        loadChildren: function () {
            return Promise.all(/*! import() | pages-tabs-page-tabs-page-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-tabs-page-tabs-page-module")]).then(__webpack_require__.bind(null, /*! ./pages/tabs-page/tabs-page.module */ "./src/app/pages/tabs-page/tabs-page.module.ts")).then(function (m) { return m.TabsModule; });
        }
    },
    {
        path: "tutorial",
    ...
    },
    {
        path: "input-location",
        loadChildren: function () {
            return Promise.all(/*! import() | pages-input-location-input-location-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-input-location-input-location-module")]).then(__webpack_require__.bind(null, /*! ./pages/input-location/input-location.module */ "./src/app/pages/input-location/input-location.module.ts")).then(function (m) { return m.InputLocationPageModule; });
        }
    },
    {
        path: "select-option-page",
        loadChildren: function () {
            return __webpack_require__.e(/*! import() | pages-select-option-page-select-option-page-module */ "pages-select-option-page-select-option-page-module").then(__webpack_require__.bind(null, /*! ./pages/select-option-page/select-option-page.module */ "./src/app/pages/select-option-page/select-option-page.module.ts")).then(function (m) { return m.SelectOptionPagePageModule; });
        }
    },
    {
        path: "vegetable-list",
        loadChildren: function () {
            return Promise.all(/*! import() | pages-vegetable-list-vegetable-list-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-vegetable-list-vegetable-list-module")]).then(__webpack_require__.bind(null, /*! ./pages/vegetable-list/vegetable-list.module */ "./src/app/pages/vegetable-list/vegetable-list.module.ts")).then(function (m) { return m.VegetableListPageModule; });
        }
    },
    {
        path: "add-vegetable-inof",
        loadChildren: function () {
            return Promise.all(/*! import() | pages-add-vegetable-inof-add-vegetable-inof-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-add-vegetable-inof-add-vegetable-inof-module")]).then(__webpack_require__.bind(null, /*! ./pages/add-vegetable-inof/add-vegetable-inof.module */ "./src/app/pages/add-vegetable-inof/add-vegetable-inof.module.ts")).then(function (m) { return m.AddVegetableInofPageModule; });
        }
    },
    {
        path: "add-fruits-info",
        loadChildren: function () {
            return Promise.all(/*! import() | pages-add-fruits-info-add-fruits-info-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-add-fruits-info-add-fruits-info-module")]).then(__webpack_require__.bind(null, /*! ./pages/add-fruits-info/add-fruits-info.module */ "./src/app/pages/add-fruits-info/add-fruits-info.module.ts")).then(function (m) { return m.AddFruitsInfoPageModule; });
        }
    },
    {
        path: "add-location",
        loadChildren: function () {
            return __webpack_require__.e(/*! import() | pages-add-location-add-location-module */ "pages-add-location-add-location-module").then(__webpack_require__.bind(null, /*! ./pages/add-location/add-location.module */ "./src/app/pages/add-location/add-location.module.ts")).then(function (m) { return m.AddLocationPageModule; });
        }
    },
    {
        path: "fruit-list",
        loadChildren: function () {
            return Promise.all(/*! import() | pages-fruit-list-fruit-list-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-fruit-list-fruit-list-module")]).then(__webpack_require__.bind(null, /*! ./pages/fruit-list/fruit-list.module */ "./src/app/pages/fruit-list/fruit-list.module.ts")).then(function (m) { return m.FruitListPageModule; });
        }
    },
    { path: 'approve-user',
        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-approve-user-approve-user-module */ "pages-approve-user-approve-user-module").then(__webpack_require__.bind(null, /*! ./pages/approve-user/approve-user.module */ "./src/app/pages/approve-user/approve-user.module.ts")).then(function (m) { return m.ApproveUserPageModule; }); } },
    { path: 'admin-panel',
        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-admin-panel-admin-panel-module */ "pages-admin-panel-admin-panel-module").then(__webpack_require__.bind(null, /*! ./pages/admin-panel/admin-panel.module */ "./src/app/pages/admin-panel/admin-panel.module.ts")).then(function (m) { return m.AdminPanelPageModule; }); } }
];
...
var AuthService = /** @class */ (function () {
    function AuthService(route, afAuth, router, userservice) {
        this.route = route;
        this.afAuth = afAuth;
        this.router = router;
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
            _angular_fire_auth__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuth"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
...
var UserServiceService = /** @class */ (function () {
    function UserServiceService(db, af) {
        this.db = db;
        this.af = af;
    ...
    UserServiceService.prototype.signUp = function (registrationForm) {
        var _this = this;
