...
const routes = [
    ...
    {
        path: "login",
        loadChildren: () => Promise.all(/*! import() | pages-login-login-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-login-login-module")]).then(__webpack_require__.bind(null, /*! ./pages/login/login.module */ "./src/app/pages/login/login.module.ts")).then(m => m.LoginModule)
    },
    {
        path: "signup",
    ...
    {
        path: "input-location",
        loadChildren: () => Promise.all(/*! import() | pages-input-location-input-location-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-input-location-input-location-module")]).then(__webpack_require__.bind(null, /*! ./pages/input-location/input-location.module */ "./src/app/pages/input-location/input-location.module.ts")).then(m => m.InputLocationPageModule)
    },
    {
        path: "select-option-page",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-select-option-page-select-option-page-module */ "pages-select-option-page-select-option-page-module").then(__webpack_require__.bind(null, /*! ./pages/select-option-page/select-option-page.module */ "./src/app/pages/select-option-page/select-option-page.module.ts")).then(m => m.SelectOptionPagePageModule)
    },
    {
        path: "vegetable-list",
        loadChildren: () => Promise.all(/*! import() | pages-vegetable-list-vegetable-list-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-vegetable-list-vegetable-list-module")]).then(__webpack_require__.bind(null, /*! ./pages/vegetable-list/vegetable-list.module */ "./src/app/pages/vegetable-list/vegetable-list.module.ts")).then(m => m.VegetableListPageModule)
    },
    {
        path: "add-vegetable-inof",
        loadChildren: () => Promise.all(/*! import() | pages-add-vegetable-inof-add-vegetable-inof-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-add-vegetable-inof-add-vegetable-inof-module")]).then(__webpack_require__.bind(null, /*! ./pages/add-vegetable-inof/add-vegetable-inof.module */ "./src/app/pages/add-vegetable-inof/add-vegetable-inof.module.ts")).then(m => m.AddVegetableInofPageModule)
    },
    {
        path: "add-fruits-info",
        loadChildren: () => Promise.all(/*! import() | pages-add-fruits-info-add-fruits-info-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-add-fruits-info-add-fruits-info-module")]).then(__webpack_require__.bind(null, /*! ./pages/add-fruits-info/add-fruits-info.module */ "./src/app/pages/add-fruits-info/add-fruits-info.module.ts")).then(m => m.AddFruitsInfoPageModule)
    },
    {
        path: "add-location",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-add-location-add-location-module */ "pages-add-location-add-location-module").then(__webpack_require__.bind(null, /*! ./pages/add-location/add-location.module */ "./src/app/pages/add-location/add-location.module.ts")).then(m => m.AddLocationPageModule)
    },
    {
        path: "fruit-list",
...
let AuthService = class AuthService {
    constructor(route, afAuth, router, userservice) {
        this.route = route;
        this.afAuth = afAuth;
        this.router = router;
