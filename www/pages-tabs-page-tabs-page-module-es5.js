...
var SchedulePage = /** @class */ (function () {
    function SchedulePage(alertCtrl, confData, loadingCtrl, modalCtrl, router, toastCtrl, user, locationService) {
    ...
    SchedulePage.prototype.searchLocation = function (locationName) {
        this.searchLtion = [];
        var filterLocation = (locationName) ?
            this.locations.filter(function (p) { return p.locationName.toLowerCase()
                .includes(locationName.toLowerCase()); }) :
            this.locations;
        this.searchLtion = filterLocation;
    };
    SchedulePage.prototype.selectFromSearchResult = function (locationName) {
