...
var AddVegetableInof = /** @class */ (function () {
    function AddVegetableInof() {
    }
    return AddVegetableInof;
}());
...
var AddVegetableInofPageModule = /** @class */ (function () {
    function AddVegetableInofPageModule() {
    }
    ...
    return AddVegetableInofPageModule;
}());
...
var AddVegetableInofPage = /** @class */ (function () {
    function AddVegetableInofPage(locationService, addVegetableInofService, toastController) {
    ...
    AddVegetableInofPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    AddVegetableInofPage.prototype.save = function (addVegetableInof) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.addVegetableInofService.startUpLoad(addVegetableInof)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    AddVegetableInofPage.prototype.uploadFile = function (event) {
    ...
    AddVegetableInofPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-add-vegetable-inof-add-vegetable-inof-module-es5.js.map