...
var FruitListPageModule = /** @class */ (function () {
    function FruitListPageModule() {
    }
...
var FruitListPage = /** @class */ (function () {
    function FruitListPage(fruitsInfoService) {
        this.fruitsInfoService = fruitsInfoService;
        this.fruitsInfo = [];
        this.filteredfruitsInfo = [];
    }
    FruitListPage.prototype.ngOnInit = function () {
        var _this = this;
        var allfruitsInfo = this.fruitsInfoService.getaddfrutsInfo()
            .snapshotChanges()
            .pipe()
            ...
            s.forEach(function (element) {
                ...
                y["key"] = element.key;
                _this.fruitsInfo.push(y);
            });
            _this.filteredfruitsInfo = _this.fruitsInfo;
        });
    };
    FruitListPage.prototype.filter = function (query) {
        console.log(query);
        var filteredProducts = (query) ?
            this.fruitsInfo.filter(function (p) { return p.fruitsName.toLowerCase()
                .includes(query.toLowerCase()); }) :
            this.fruitsInfo;
        this.filteredfruitsInfo = filteredProducts;
        console.log(this.filteredfruitsInfo);
    };
    FruitListPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-fruit-list-fruit-list-module-es5.js.map