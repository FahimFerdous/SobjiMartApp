...
module.exports = ".signup-logo {\n  padding: 20px 0;\n  min-height: 200px;\n  text-align: center;\n}\n\n.signup-logo img {\n  max-width: 150px;\n}\n\n.list {\n  margin-bottom: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var SignupPage = /** @class */ (function () {
    function SignupPage(router, userData, UserService) {
        this.router = router;
    ...
    SignupPage.prototype.onSignup = function (form) {
        ...
        if (form.email != "" && form.password != "" && form.length != 0 && form.email && form.password) {
            this.UserService.signUp(form).then(function (t) { return _this.router.navigateByUrl('/app/tabs/schedule'); }).catch(function (error) {
                // alert(error.message);
